...
public class Calculator/*@bgen(jjtree)*/implements CalculatorTreeConstants, CalculatorConstants {/*@bgen(jjtree)*/
  ...
  static final public void Expr1(int signal) throws ParseException {
    Expr2(signal);
    if (jj_2_6(3)) {
      label_2:
      while (true) {
  ...
  static final public void Expr2(int signal) throws ParseException {
    Expr3(signal);
    if (jj_2_10(3)) {
      label_3:
      while (true) {
  ...
  static final public void Expr3(int signal) throws ParseException {
                               Token t;
    if (jj_2_19(3)) {
      if (jj_2_11(3)) {
        ...
        try {
              ...
              jjtc001 = false;
             jjtn001.val = signal * symbols.get(t.image);
        } finally {
              if (jjtc001) {
                jjtree.closeNodeScope(jjtn001, true);
              }
      ...
      if (jj_2_15(3)) {
        ...
        try {
                  ...
                  jjtc002 = false;
                 jjtn002.val = signal *Integer.parseInt(t.image);
        } finally {
                  if (jjtc002) {
                    jjtree.closeNodeScope(jjtn002, true);
                  }
